<?php
namespace Elementor_RentMy_Addons;
...
final class Plugin {
	...
	public function init() {
		...
		add_action('elementor/elements/categories_registered', [$this, 'add_custom_widget_category']);
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/Single_product.php' );
		require_once( __DIR__ . '/widgets/Product_list.php' );
		require_once( __DIR__ . '/widgets/Cart_total.php' );

		$widgets_manager->register( new \Single_product() );
		$widgets_manager->register( new \Product_list() );
		$widgets_manager->register( new \Cart_total() );
	...
	public function add_custom_widget_category($elements_manager) {
		$elements_manager->add_category(
			'RentMy',
			[
				'title' => __('RentMy', RNTM_TEXT_DOMAIN), 
				// 'icon' => 'fa fa-plug',
				'icon' => plugin_dir_url(__FILE__) . "/admin/assets/icon.png"
			]
		);
	}
